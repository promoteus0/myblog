        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    {{ __("List Aktifitas ") }}
                    <form method="post" enctype="multipart/form-data" action="{{ route('aktifitas.store') }}" class="mt-6 space-y-6">
                        @csrf
                        <div>
                        ...
                        <div>
                            ...
                            <x-text-input id="description" name="description" type="text" class="block w-full mt-1" :value="old('description')" required autofocus autocomplete="description" />
