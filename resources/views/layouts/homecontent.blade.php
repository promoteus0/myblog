...
<div class="px-6 py-6 mx-auto max-w-7xl lg:px-8 ">
  ...
  <h2 class="pt-20 font-bold tracking-tight text-gray-900 text-5xlxl sm:text-4xl">My Actifity</h2>
...
@foreach ($aktifitas as $data )
    ...
    <a href="">
      ...
      <div class="relative group">
        <h3 class="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
          <a href="{{ url('/view-aktifitas/'.$data->slug) }}">
      ...
      <div class="relative flex items-center mt-8 gap-x-4">
        <img src="{{asset('storage/profile-image')}}/{{$data->user->photo_profile_path}}" alt="{{ $data->user->photo_profile_path }}" class="w-10 h-10 rounded-full bg-gray-50">
    ...
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="#">
          <img class="w-full rounded-t-lg h-60" src="{{asset('storage/image')}}/{{$data->photo}}" alt="{{ $data->photo }}" />
      </a>
      ...
      <div class="p-5">
          ...
          <a href="{{ url('/view-aktifitas/'.$data->slug) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Read more
